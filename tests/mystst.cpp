...
public:
    ...
    {
        MockMystique* myst1 = (MockMystique*)instance1;
...
namespace ASM
{
    ...
    //Offset 0x6ae5
    Hag::System::BDA::VideoParameterTable Data0x6ae5[] =
    {
        0x50,
        0x0B,
        0x08,
    ...
    //Offset 0x6b25
    Hag::System::BDA::VideoParameterTable Data0x6b25[] =
    {
        0x50,
        0x0B,
        0x08,
    ...
    //Offset 0x6c63
    Hag::System::BDA::VideoParameterTable Data0x6c63[] =
    {
        0x64,
        0x24,
        0x10,
    ...
    //Offset 0x6b65
    Hag::System::BDA::VideoParameterTable Data0x6b65[] =
    {
        0x50,
        0x0B,
        0x08,
    ...
    //Offset 0x6ba5
    Hag::System::BDA::VideoParameterTable Data0x6ba5[] =
    {
        0x50,
        0x0B,
        0x08,
    ...
    //Offset 0x6be5
    Hag::System::BDA::VideoParameterTable Data0x6be5[] =
    {
        0x50,
        0x0B,
        0x08,
    ...
    //Offset 0x6c24
    Hag::System::BDA::VideoParameterTable Data0x6c24[] =
    {
        0x50,
        0x0B,
        0x08,
    ...
    //Offset 0x6ca3
    Hag::System::BDA::VideoParameterTable Data0x6ca3[] =
    {
        0x50,
        0x3B,
        0x08,
    ...
    //Offset 0x6ce3
    Hag::System::BDA::VideoParameterTable Data0x6ce3[] =
    {
        0x84,
        0x18,
        0x10,
    ...
    //Offset 0x6d23
    Hag::System::BDA::VideoParameterTable Data0x6d23[] =
    {
        0x84,
        0x2A,
        0x08,
    ...
    //Offset 0x6d63
    Hag::System::BDA::VideoParameterTable Data0x6d63[] =
    {
        0x84,
        0x31,
        0x08,
    ...
    //Offset 0x6da3
    Hag::System::BDA::VideoParameterTable Data0x6da3[] =
    {
        0x84,
        0x3B,
        0x08,
    ...
    struct VesaMode
    {
        ...
        uint8_t OffsetHack;//Not used by us.
    ...
    void Func0x6310(VesaMode* siPointer)//Offset 0x6310
    {
        ...
        if ((siPointer->Flags & 0x10) == 0x00)
            goto Label0x63b8;

        //     test byte ptr [si + 0bh], 20h
        //     je   Label0x6385                    ;Offset 0x6385
        if ((siPointer->Flags & 0x20) == 0x00)
            goto Label0x6385;
    ...
    void SetStartAddress(uint32_t address, uint8_t bl)//Offset 0x5a28
    {
        using namespace Hag;
        using namespace Hag::System;
        using namespace Hag::Matrox;
    ...
    LABEL(SetStartAddress, Label0x5a43);
        ...
        if ((r.h.al & VGA::InputStatus1::VerticalSyncActive) == 0)
            goto Label0x5a43;

        // Label0x5a48:                            ;Offset 0x5a48
    LABEL(SetStartAddress, Label0x5a48);
        ...
        //     out   dx, al
        VGA::CRTController::StartAddressLow::Write(VGA::Register::CRTControllerIndexD, r.h.al);
        ...
        //     xchg  al, ah
        //     out   dx, al
        VGA::CRTController::StartAddressHigh::Write(VGA::Register::CRTControllerIndexD, r.h.ah);
        ...
        r.h.al &= ~Shared::CRTCExtension::AddressGeneratorExtensions::StartAddress19_16;
    ...
    LABEL(Func0x6518, Label0x65cf);
        ...
        //     mov       al, MGA_CRTCExt_HorCounterExt;0x1
        //     out       dx, ax
        Shared::CRTCExtension::HorizontalCounterExtensions::Write(siPointer->HorizontalCounterExtensions);

        //     mov       ah, byte ptr [si + 11h]
        //     mov       al, MGA_CRTCExt_VertCounterExt;0x2
        //     out       dx, ax
        Shared::CRTCExtension::VerticalCounterExtensions::Write(siPointer->VerticalCounterExtensions);
    ...
    LABEL(SetVESAMode, Label0x73a4);
        ...
        //     jle   SetLegacyMode                   ;Offset 0x73b1
        if (r.w.ax <= VGA::VideoMode::G320x200x8bppC)
            goto SetLegacyMode;
        ...
        // SetLegacyMode:                            ;Offset 0x73b1
    LABEL(SetVESAMode, SetLegacyMode);
...
namespace CPP
{
    ...
    Scanlines_t GetNumberOfActiveScanlines()
    {
        using namespace Hag;
        using namespace Hag::System;
            ...
            ((scanlines = Scanlines::PerMode[BDA::DisplayMode::Get()]) == Scanlines::Invalid))
        {
            ...
            if ((BDA::VideoDisplayDataArea::Get() & BDA::VideoDisplayDataArea::LineMode400) == 0)
            {
                ...
                if (!IsMDAHiResEnhanced() && (BDA::DisplayMode::Get() != VGA::VideoMode::T80x25x1bppM))
                {
    ...
    Hag::System::BDA::VideoParameterTable Mode4And5SL200 =
    {
        ...
        { 0x09, 0x03, 0x00, 0x02 },
        0x63,
        { 0x2D, 0x27, 0x28, 0x90, 0x2B, 0x80, 0xBF, 0x1F, 0x00, 0xC0, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9C, 0x8E, 0x8F, 0x14, 0x00, 0x96, 0xB9, 0xA2, 0xFF },
        { 0x00, 0x13, 0x15, 0x17, 0x02, 0x04, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x01, 0x00, 0x03, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x0F, 0x00, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable Mode6SL200 =
    {
        ...
        { 0x01, 0x01, 0x00, 0x06 },
        0x63,
        { 0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0xBF, 0x1F, 0x00, 0xC0, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9C, 0x8E, 0x8F, 0x28, 0x00, 0x96, 0xB9, 0xC2, 0xFF },
        { 0x00, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x01, 0x00, 0x01, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0D, 0x00, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable Mode8SL400 =
    {
        0x50,
        0x18,
        0x10,
        ...
        { 0x21, 0x0F, 0x00, 0x06 },
        0x63,
        { 0x5F, 0x4F, 0x50, 0x82, 0x55, 0x81, 0xBF, 0x1F, 0x00, 0x40, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9C, 0x8E, 0x8F, 0x28, 0x1F, 0x96, 0xB9, 0xE3, 0xFF },
        { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x14, 0x07, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x01, 0x00, 0x0F, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x0F, 0xFF }
    };

    Hag::System::BDA::VideoParameterTable Mode9SL200 =
    {
        0x00,
        0x00,
        0x00,
    ...
    Hag::System::BDA::VideoParameterTable ModeASL200 =
    {
        0x28,
        0x18,
        0x08,
    ...
    Hag::System::BDA::VideoParameterTable ModeBSL200 =
    {
        0x50,
        0x00,
        0x00,
    ...
    Hag::System::BDA::VideoParameterTable ModeCSL200 =
    {
        0x50,
        0x00,
        0x00,
    ...
    Hag::System::BDA::VideoParameterTable ModeDSL200 =
    {
        ...
        { 0x09, 0x0F, 0x00, 0x06 },
        0x63,
        { 0x2D, 0x27, 0x28, 0x90, 0x2B, 0x80, 0xBF, 0x1F, 0x00, 0xC0, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9C, 0x8E, 0x8F, 0x14, 0x00, 0x96, 0xB9, 0xE3, 0xFF },
        { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x01, 0x00, 0x0F, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x0F, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable ModeESL200 =
    {
        ...
        { 0x01, 0x0F, 0x00, 0x06 },
        0x63,
        { 0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0xBF, 0x1F, 0x00, 0xC0, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9C, 0x8E, 0x8F, 0x28, 0x00, 0x96, 0xB9, 0xE3, 0xFF },
        { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x01, 0x00, 0x0F, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x0F, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable ModeFSL350 =
    {
        ...
        { 0x01, 0x0F, 0x00, 0x06 },
        0xA2,
        { 0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0xBF, 0x1F, 0x00, 0x40, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x83, 0x85, 0x5D, 0x28, 0x0F, 0x63, 0xBA, 0xE3, 0xFF },
        { 0x00, 0x08, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x0B, 0x00, 0x05, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x05, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable Mode11SL480 =
    {
        ...
        { 0x01, 0x0F, 0x00, 0x06 },
        0xE3,
        { 0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0x0B, 0x3E, 0x00, 0x40, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEA, 0x8C, 0xDF, 0x28, 0x00, 0xE7, 0x04, 0xC3, 0xFF },
        { 0x00, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x3F, 0x01, 0x00, 0x0F, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x01, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable Mode12SL480 =
    {
        ...
        { 0x01, 0x0F, 0x00, 0x06 },
        0xE3,
        { 0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0x0B, 0x3E, 0x00, 0x40, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEA, 0x8C, 0xDF, 0x28, 0x00, 0xE7, 0x04, 0xE3, 0xFF },
        { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x14, 0x07, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x01, 0x00, 0x0F, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x0F, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable Mode13SL200 =
    {
        ...
        { 0x01, 0x0F, 0x00, 0x0E },
        0x63,
        { 0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0xBF, 0x1F, 0x00, 0x40, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9C, 0x8E, 0x8F, 0x28, 0x40, 0x96, 0xB9, 0xA3, 0xFF },
        { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x41, 0x00, 0x0F, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x05, 0x0F, 0xFF }
    };
    ...
    Hag::System::BDA::VideoParameterTable* VideoParameterVariantsPerMode[20][4] =
    {
        ...
        { &Mode9SL200, &DefaultParameters, &DefaultParameters, &DefaultParameters },    // 0x09
        { &ModeASL200, &DefaultParameters, &DefaultParameters, &DefaultParameters },    // 0x0a
        { &ModeBSL200, &DefaultParameters, &DefaultParameters, &DefaultParameters },    // 0x0b
        { &ModeCSL200, &DefaultParameters, &DefaultParameters, &DefaultParameters },    // 0x0c
        { &ModeDSL200, &DefaultParameters, &DefaultParameters, &DefaultParameters },    // 0x0d
        { &ModeESL200, &DefaultParameters, &DefaultParameters, &DefaultParameters },    // 0x0e
        { &DefaultParameters, &ModeFSL350, &DefaultParameters, &DefaultParameters },    // 0x0f
        { &DefaultParameters, &Mode10SL350, &DefaultParameters, &DefaultParameters },   // 0x10
        { &DefaultParameters, &DefaultParameters, &DefaultParameters, &Mode11SL480 },   // 0x11
        { &DefaultParameters, &DefaultParameters, &DefaultParameters, &Mode12SL480 },   // 0x12
        { &Mode13SL200, &DefaultParameters, &DefaultParameters, &DefaultParameters }    // 0x13
    };

    Hag::System::BDA::VideoParameterTable* GetVideoParameterTable()
    {
        return VideoParameterVariantsPerMode[Hag::System::BDA::DisplayMode::Get()][GetNumberOfActiveScanlines()];
    }
    ...
    void ClearScreen()
    {
        ...
        if (((BDA::VideoModeOptions::Get() & BDA::VideoModeOptions::DontClearDisplay) == 0) &&
            (BDA::VideoBufferSize::Get() != 0x0000))
        {
            VGA::VideoMode_t videoMode = VesaToLegacyModeEquivalent(BDA::DisplayMode::Get());
            uint16_t segment = 0xA000;
            uint16_t count = 0x8000;
    ...
    bool ShouldLoadTextFont()
    {
        using namespace Hag;
        using namespace Hag::System;

        VGA::VideoMode_t mode = VesaToLegacyModeEquivalent(BDA::DisplayMode::Get());
        if (mode == VGA::VideoMode::T80x25x1bppM) return true;
        if (mode > VGA::VideoMode::T80x25x4bppC) return false;
        return true;
    }
    ...
    void UploadFont(uint8_t* font, uint16_t count, uint8_t fontHeight, uint8_t bankIndex, bool patch)
    {
        ...
        do
        {
            ...
            uint8_t span = fontHeight == 0 ? 16 : fontHeight;
    ...
    void SelectAndLoadFont()
    {
        ...
        Scanlines_t scanLines = GetNumberOfActiveScanlines();

        if (scanLines == Scanlines::S200)
        {
            UploadFont(Font8x8, 256, 8, 0, false);
        }
        else if (scanLines == Scanlines::S350)
        {
            if (BDA::DisplayMode::Get() != VGA::VideoMode::T80x25x1bppM)
            {
                UploadFont(Font8x16, 256, 0, 0, false);
            }
            else
            {
                UploadFont(Font8x16, 256, 0, 0, true);
            }
        }
        else
        {
            UploadFont(Font8x16, 256, 16, 0, true);
        }
    ...
    void ApplyMode(Hag::VGA::VideoMode_t videoMode, Hag::System::BDA::VideoModeOptions_t videoModeOptions, Hag::VGA::Register_t videoBaseIOPort, Hag::System::BDA::VideoParameterTable* videoParameterTableOverride)
    {
        using namespace Hag;
        using namespace Hag::System;
        using namespace Hag::Matrox::Shared;
        ...
        TurnScreenOff();
        BDA::DisplayMode::Get() = videoMode;
        BDA::VideoModeOptions::Get() = videoModeOptions;
        BDA::VideoBaseIOPort::Get() = videoBaseIOPort;
        ...
        ApplyVideoParameters(videoParameterTable, Hag::System::BDA::VideoBaseIOPort::Get());
    ...
    void ConfigureEGAFeatureBitSwitchesAdapter(Hag::VGA::VideoMode_t& videoMode, Hag::System::BDA::VideoModeOptions_t& videoModeOptions)
    {
        using namespace Hag;
        using namespace Hag::System;
    ...
    Hag::Vesa::VideoMode_t TranslateSpecialModes(Hag::Vesa::VideoMode_t videoMode)
    {
        if (videoMode == 0x81FF)
            videoMode = 0x11f;
    ...
    bool ValidateVesaMode(Hag::Vesa::VideoMode_t videoMode)
    {
        ...
        videoMode &= Vesa::VideoMode::ModeMask;

        Vesa::VideoMode_t* modes = SupportedVESAVideoModes;
    ...
    Hag::System::BDA::VideoParameterTable Data0x6c63[] =
    {
        ...
        { 0x01, 0x0F, 0x00, 0x06 },
        0x2F,
        { 0x7F, 0x63, 0x63, 0x82, 0x6B, 0x1B, 0x72, 0xF0, 0x00, 0x60, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58, 0x8C, 0x57, 0x32, 0x00, 0x57, 0x73, 0xE3, 0xFF },
        { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x14, 0x07, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x01, 0x00, 0x0F, 0x00 },
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x0F, 0xFF }
    };
    ...
    void ConfigurePixelClocks(uint32_t mnps, PixelClocksSettings_t PllAndClock)
    {
        ...
        Shared::PCI::IndexedData::Write(mystique, pllIndex + 0, (mnps >> 8) & Shared::Indexed::PixelPLLM::MValue);
        Shared::PCI::IndexedData::Write(mystique, pllIndex + 1, mnps & Shared::Indexed::PixelPLLN::NValue);
        Shared::PCI::IndexedData::Write(mystique, pllIndex + 2, (mnps  >> 13) &
        ...
        do
        {
            ...
            frequencyLock = Shared::PCI::Indexed::PixelPLLStatus::Read(mystique) &
                Shared::Indexed::PixelPLLStatus::FrequencyStatus;
        ...
        VGA::MiscellaneousOutput_t clockSelect = Shared::MiscellaneousOutput::ClockSelectMGAPixelClock;
        if (clockControl == Shared::Indexed::PixelClockControl::ClockPCI)
            clockSelect = VGA::MiscellaneousOutput::ClockSelect25p175MHz;
        else if (clockControl == Shared::Indexed::PixelClockControl::ClockPLL)
            clockSelect = VGA::MiscellaneousOutput::ClockSelect28p322MHz;

        VGA::MiscellaneousOutput::Write((VGA::MiscellaneousOutput::Read() & ~VGA::MiscellaneousOutput::ClockSelect) | clockSelect);
        VGA::Sequencer::ClockingMode::Write(VGA::Sequencer::ClockingMode::Read() & ~VGA::Sequencer::ClockingMode::ScreenOff);
    }
    ...
    void ConfigurePalette(Hag::System::PCI::Device_t device)
    {
        ...
        switch(Shared::PCI::Indexed::MultiplexControl::Read(device) &
                Shared::Indexed::MultiplexControl::ColorDepth)
        {
        case Shared::Indexed::MultiplexControl::Bits24p8x:
            do
            {
                VGA::DACWriteIndex::Write(idxcol);
            ...
            break;
        case Shared::Indexed::MultiplexControl::Bits16p:
            do
            {
                VGA::DACWriteIndex::Write(idxcol);
    ...
    void ApplyVesaSettings(VesaMode* siPointer)
    {
        ...
        BDA::VideoBufferSize::Get() = uint16_t(Max4MB(GetMemoryIn64KBlocks())) << 8;
        
        PCI::FindDevice(0x102B, 0x051A, device);
        if ((siPointer->Flags & 0x03) == 0x00)
        {
            Shared::PCI::Option::WriteByte1(device,
                Shared::PCI::Option::ReadByte1(device) &
                ~Shared::PCI::Option::SplitMode);
            ...
            if ((siPointer->Flags & 0x20) != 0x00)
            {
                ...
                Shared::PCI::Indexed::MiscellaneousControl::Write(device,
                    Shared::PCI::Indexed::MiscellaneousControl::Read(device) |
                    Shared::Indexed::MiscellaneousControl::VGADAC8Bit);

                Shared::PCI::Indexed::MultiplexControl::Write(device,
                    Shared::Indexed::MultiplexControl::Bits24p8x);
                ...
                ConfigurePalette(device);

                offsetAdjust = 2;

            }
            else if ((siPointer->Flags & 0x10) != 0x00)
            {
                BDA::VideoBufferSize::Get() = (BDA::VideoBufferSize::Get() & 0xFF00) | 0x02;
    ...
    uint16_t GetVideoMemorySize()
    {
        uint16_t ret = 1;

        if (Hag::System::BDA::DisplayMode::Get() != Hag::VGA::VideoMode::G320x200x8bppC)
            ret = Hag::System::BDA::VideoBufferSize::Get() & 0xFF0F;
    ...
    void ClearVideoMemory()
    {
        ...
        FARPointer ptr(0xA000, 0x0000);

        uint8_t count = uint8_t(GetVideoMemorySize() >> 8);

        for (uint8_t i = 0; i < count; ++i)
        {
            Shared::CRTCExtension::MemoryPage::Write(i);
            memset(ptr.ToPointer<uint8_t>(0x10000), 0, 0x10000);
        }
        Shared::CRTCExtension::MemoryPage::Write(0);
    }

    void SetStartAddress(uint32_t address, bool waitOnSync)
    {
        using namespace Hag;
        using namespace Hag::System;
        using namespace Hag::Matrox;
        ...
        if (waitOnSync)
        {
            VGA::InputStatus1_t inputStatus1;
            do
            {
                inputStatus1 = VGA::InputStatus1::Read(VGA::Register::InputStatus1D);
            } while ((inputStatus1 & VGA::InputStatus1::VerticalSyncActive) == 0);
        }
    ...
    bool SetLegacyModeInternal(Hag::VGA::VideoMode_t videoMode, Hag::System::BDA::VideoParameterTable* videoParameterTableOverride);

    void ApplyVesaMode(Hag::Vesa::VideoMode_t videoMode, VesaMode* vesaMode)
    {
        using namespace Hag;
        using namespace Hag::System;
        using namespace Hag::Matrox;
        ...
        ConfigurePixelClocks(CalculatePLL_MNPS(vesaMode->FrequencyKHz), PixelClocksSettings::PLLSetC | PixelClocksSettings::ClockPLL);

        SetLegacyModeInternal(vesaMode->LegacyMode | ((videoMode >> 8) & 0x80), vesaMode->VideoParameters);

        TurnScreenOff();

        if ((vesaMode->Flags & 0x80) != 0x00)
        {
            ConfigureFontLoadMemoryMapping();
            UploadFont(Font8x8, 256, 8, 0, false);
            ConfigureTextMemoryMapping();
        ...
        Shared::CRTCExtension::HorizontalCounterExtensions::Write(vesaMode->HorizontalCounterExtensions);
        Shared::CRTCExtension::VerticalCounterExtensions::Write(vesaMode->VerticalCounterExtensions);

        ApplyVesaSettings(vesaMode);

        if (((vesaMode->Flags & 0x02) == 0) && ((videoMode & 0x8000) == 0))
            ClearVideoMemory();

        SetStartAddress(0, false);
        TurnScreenOn();
    }

    bool SetLegacyMode(Hag::VGA::VideoMode_t videoMode);
    ...
    bool SetVESAMode(Hag::Vesa::VideoMode_t videoMode)
    {
        ...
        if (!IsExtensionReg7Writeable())
        {
            ...
            Vesa::VideoMode_t translatedMode = TranslateSpecialModes(videoMode);

            if (uint8_t(translatedMode) == 0x1F)
            {
                translatedMode = Hag::Vesa::VideoMode::G640x400x8bpp;
            }

            if (ValidateVesaMode(translatedMode))
            {
                ApplyVesaMode(videoMode, VesaModes[uint8_t(translatedMode)]);
                if (uint8_t(translatedMode) == 0x1F)
                {
                    VGA::Sequencer::ClockingMode::Write(VGA::Sequencer::ClockingMode::ScreenOff);
                }
            ...
            {
                if (videoMode > VGA::VideoMode::G320x200x8bppC)
                {
                    return false;
                }
                else if (SetLegacyMode(uint8_t(videoMode)))
                {
                    return true;
                }
            }

            uint8_t convertedMode = uint8_t(videoMode) & 0x7F;

            if ((videoMode & 0x7F7F) >= Vesa::VideoMode::G640x400x8bpp)
            {
                convertedMode += 0x20;
            }

            convertedMode |= (videoMode >> 8) & 0xC0;

            BDA::DisplayMode::Get() = convertedMode;
    ...
    bool SetLegacyModeInternal(Hag::VGA::VideoMode_t videoMode, Hag::System::BDA::VideoParameterTable* videoParameterTableOverride)
    {
        ...
        if ((BDA::VideoDisplayDataArea::Get() & BDA::VideoDisplayDataArea::Reserved) != 0)
        {
            videoMode |= VGA::VideoMode::DontClearDisplay;
        }

        BDA::VideoModeOptions_t videoModeOptions = BDA::VideoModeOptions::Get();

        videoModeOptions &= ~BDA::VideoModeOptions::DontClearDisplay;
        videoModeOptions |= videoMode & BDA::VideoModeOptions::DontClearDisplay;
        videoMode &= ~BDA::VideoModeOptions::DontClearDisplay;
        ...
        if (videoMode <= VGA::VideoMode::G320x200x8bppC)
        {
                ...
                (videoMode != VGA::VideoMode::G640x350x1bppM))
            {
                BDA::DetectedHardware::Get() = 
                    ...
                    BDA::DetectedHardware::Color80x25;
            }
            else
            {
                BDA::DetectedHardware::Get() = 
            ...
            if ((BDA::DetectedHardware::Get() & BDA::DetectedHardware::InitialVideoModeMask) == BDA::DetectedHardware::Monochrome80x25)
            {
                ...
                {
                    if ((videoMode == Hag::VGA::VideoMode::T80x25x1bppM) ||
                        (videoMode == Hag::VGA::VideoMode::G640x350x1bppM))
                    {
                        ApplyMode(videoMode, videoModeOptions, Hag::VGA::Register::CRTControllerIndexB, videoParameterTableOverride);
                    }
                    else
                    {
                        //We never get here.
            ...
            else if ((videoModeOptions & BDA::VideoModeOptions::Monochrome) == 0)
            {
                if ((videoMode != VGA::VideoMode::T80x25x1bppM) && (videoMode != VGA::VideoMode::G640x350x1bppM))
                {
                    ApplyMode(videoMode, videoModeOptions, VGA::Register::CRTControllerIndexD, videoParameterTableOverride);
                } else
                {
                    //We never get here.
                    ApplyMode(0x03, videoModeOptions & ~Hag::System::BDA::VideoModeOptions::DontClearDisplay, VGA::Register::CRTControllerIndexD, videoParameterTableOverride);
                }
                ret = true;
            }
            return ret;
        ...
        if (videoMode == 0x6A)
            return SetVESAMode(Vesa::VideoMode::G800x600x4bpp);

        return SetVESAMode(((videoMode & 0xC0) << 8) | ((videoMode & 0x3F) - 0x20) | 0x100);
    }
