    0x4E, 0xF1, 0x07, 0x36, 0x07, 0x00, 0x0E, 0x88, 0x0B,   //27
    0x4F, 0xB1, 0x07, 0x32, 0x07, 0x05, 0x0E, 0xB8, 0x0B,   //28
    0x52, 0xB1, 0x06, 0x36, 0x03, 0x04, 0x0E, 0xC4, 0x0B,   //29
    0xFF
};
...
uint8_t ModeData[][12] =
{
    {0x3B, 0x06, 0x80, 0x02, 0x00, 0x08, 0x08, 0x38, 0x38, 0x00, 0x00, 0x00},//0, //ModeData132x43x8
    {0x7B, 0x06, 0x80, 0x02, 0x00, 0x08, 0x08, 0x38, 0x38, 0x00, 0x00, 0x00},//1, //ModeData132x25x8
    {0xBB, 0x06, 0x80, 0x00, 0x40, 0xF8, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},//2, // ModeData640x400x8
    {0xFB, 0x06, 0x80, 0x00, 0x40, 0x88, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0xD0, 0x0B, 0x01, 0x0B, 0x40, 0x88, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0xE9, 0x0B, 0x02, 0x0B, 0x40, 0x88, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},//5, // ModeData640x480x8
    ...
    {0x34, 0x0C, 0x03, 0x10, 0x02, 0x48, 0xF8, 0xFF, 0xFF, 0x08, 0x00, 0x00},//9, // ModeData800x600x4
    ...
    {0x34, 0x0C, 0x03, 0x10, 0x82, 0x48, 0xF8, 0xFF, 0xFF, 0x08, 0x00, 0x00},//13, // ModeData800x600x8
    ...
    {0x7F, 0x0C, 0x04, 0x0A, 0x02, 0x10, 0xC0, 0xFF, 0xFF, 0x00, 0x00, 0x01},//17, // ModeData1024x768x4
    {0x7B, 0x07, 0x80, 0x27, 0x00, 0x60, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x4D, 0x0C, 0x02, 0x0D, 0x00, 0x30, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x66, 0x0C, 0x03, 0x0E, 0x00, 0x10, 0x48, 0xFF, 0x48, 0x00, 0x00, 0x01},
    {0x7F, 0x0C, 0x04, 0x0A, 0x02, 0x10, 0x48, 0xFF, 0xFF, 0x00, 0x00, 0x01},//21, // ModeData1024x768x8
    {0xBB, 0x07, 0x82, 0x2E, 0x00, 0x38, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},//22, // ModeData1280x1024x4
    ...
    {0xC4, 0x0D, 0x04, 0x0A, 0x12, 0x10, 0x10, 0xFF, 0xFF, 0x5D, 0x00, 0x50},//42, // ModeData1024x768x16
    {0x7B, 0x07, 0x80, 0x27, 0x30, 0x38, 0x38, 0xFF, 0xFF, 0x00, 0x00, 0xD0},//43, // ModeData1024x768x32
    {0xDD, 0x0D, 0x82, 0x2A, 0xD0, 0x10, 0x10, 0xFF, 0xFF, 0x7F, 0x00, 0x50},//44, // ModeData1280x1024x16
    {0x3B, 0x08, 0x80, 0x29, 0x81, 0x00, 0x00, 0xFF, 0xFF, 0x01, 0x00, 0x10},//45, // ModeData1600x1200x8
    {0xFB, 0x06, 0x80, 0x00, 0x00, 0x88, 0x88, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0xD0, 0x0B, 0x01, 0x0B, 0x00, 0x88, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0xE9, 0x0B, 0x02, 0x0B, 0x00, 0x88, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},//48, // ModeData640x480x8xOEM
    {0x3B, 0x07, 0x80, 0x06, 0x00, 0x80, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x02, 0x0C, 0x01, 0x02, 0x02, 0x70, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x1B, 0x0C, 0x02, 0x04, 0x02, 0x48, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x34, 0x0C, 0x03, 0x10, 0x02, 0x48, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},//52, // ModeData800x600x4xOEM
    {0x3B, 0x07, 0x80, 0x06, 0x00, 0x80, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x02, 0x0C, 0x01, 0x02, 0x00, 0x70, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x1B, 0x0C, 0x02, 0x04, 0x00, 0x48, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x34, 0x0C, 0x03, 0x10, 0x00, 0x48, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},//56, // ModeData800x600x8xOEM
    {0x7B, 0x07, 0x80, 0x27, 0x00, 0x60, 0xC0, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x4D, 0x0C, 0x02, 0x0D, 0x00, 0x30, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x66, 0x0C, 0x03, 0x0E, 0x00, 0x10, 0xC8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x7F, 0x0C, 0x04, 0x0A, 0x02, 0x10, 0xC0, 0xFF, 0xFF, 0x00, 0x00, 0x00},//60, // ModeData1024x768x4xOEM
    {0x7B, 0x07, 0x80, 0x27, 0x00, 0x60, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x4D, 0x0C, 0x02, 0x0D, 0x00, 0x30, 0xF8, 0xFF, 0xFF, 0x00, 0x00, 0x00},
    {0x66, 0x0C, 0x03, 0x0E, 0x00, 0x10, 0x48, 0xFF, 0x48, 0x00, 0x00, 0x00},
    {0x7F, 0x0C, 0x04, 0x0A, 0x02, 0x10, 0x48, 0xFF, 0xFF, 0x00, 0x00, 0x00},//64, // ModeData1024x768x8xOEM
    {0xFB, 0x07, 0x84, 0x0A, 0x01, 0x10, 0x40, 0xFF, 0xFF, 0x00, 0x00, 0x00},//65, // ModeData1152x864x8xOEM
    ...
    {0xCA, 0x0C, 0x46, 0x08, 0x02, 0x18, 0x80, 0xFF, 0xFF, 0x00, 0x15, 0x10},//69, // ModeData1280x1024x4xOEM
    {0xBB, 0x06, 0x81, 0x00, 0x70, 0x08, 0x08, 0xFF, 0xFF, 0x00, 0x00, 0xD0} //70 // ModeData640x400x32xOEM
};

uint8_t* crtDataPtr[] =
{
    &VESAVideoParameters132x43[10],//Data063B,      //0
    &VESAVideoParameters132x25[10],//Data067B,      //1
    &VESAVideoParameters640x400[10],//Data06BB,     //2
    &VESAVideoParameters640x480[10],//Data06FB,     //3
    Data0BD0,                                       //4
    Data0BE9,                                       //5
    &VESAVideoParameters800x600[10],//Data073B,     //6
    Data0C02,                                       //7
    Data0C1B,                                       //8
    Data0C34,                                       //9
    &VESAVideoParameters800x600[10],//Data073B,     //10
    Data0C02,                                       //11
    Data0C1B,                                       //12
    Data0C34,                                       //13
    &VESAVideoParameters1024x768[10],//Data077B,    //14
    Data0C4D,                                       //15
    Data0C66,                                       //16
    Data0C7F,                                       //17
    &VESAVideoParameters1024x768[10],//Data077B,    //18
    Data0C4D,                                       //19
    Data0C66,                                       //20
    Data0C7F,                                       //21
    &VESAVideoParameters1280x1024[10],//Data07BB,   //22
    &VESAVideoParameters1280x1024[10],//Data07BB,   //23
    Data0C98,                                       //24
    Data0CB1,                                       //25
    Data0CCA,                                       //26
    Data0CE3,                                       //27
    Data0CFC,                                       //28
    Data0D15,                                       //29
    &VESAVideoParameters640x480[10],//Data06FB,     //30
    Data0BD0,                                       //31
    Data0BE9,                                       //32
    Data0D2E,                                       //33
    Data0D47,                                       //34
    ...
    Data0DAB,                                       //41
    Data0DC4,                                       //42
    &VESAVideoParameters1024x768[10],//Data077B,    //43
    Data0DDD,                                       //44
    &VESAVideoParameters1600x1200[10],//Data083B,   //45
    &VESAVideoParameters640x480[10],//Data06FB,     //46
    Data0BD0,                                       //47
    Data0BE9,                                       //48
    &VESAVideoParameters800x600[10],//Data073B,     //49
    Data0C02,                                       //50
    Data0C1B,                                       //51
    Data0C34,                                       //52
    &VESAVideoParameters800x600[10],//Data073B,     //53
    Data0C02,                                       //54
    Data0C1B,                                       //55
    Data0C34,                                       //56
    &VESAVideoParameters1024x768[10],//Data077B,    //57
    Data0C4D,                                       //58
    Data0C66,                                       //59
    Data0C7F,                                       //60
    &VESAVideoParameters1024x768[10],//Data077B,    //61
    Data0C4D,                                       //62
    Data0C66,                                       //63
    Data0C7F,                                       //64
    &VESAVideoParameters1152x864[10],//Data07FB,    //65
    &VESAVideoParameters1280x1024[10],//Data07BB,   //66
    Data0C98,                                       //67
    Data0CB1,                                       //68
    Data0CCA,                                       //69
    &VESAVideoParameters640x400[10]//Data06BB       //70
};
...
uint8_t ModeDataIndex[] =
{
    ...
    5, // ModeData640x480x8
    9, // ModeData800x600x4
    13, // ModeData800x600x8
    17, // ModeData1024x768x4
    21, // ModeData1024x768x8
    22, // ModeData1280x1024x4
    26, // ModeData1280x1024x8
    29, // ModeData640x480x16
    29, // ModeData640x480x16
    32, // ModeData640x480x32
    35, // ModeData800x600x16
    35, // ModeData800x600x16
    38, // ModeData800x600x32
    42, // ModeData1024x768x16
    42, // ModeData1024x768x16
    43, // ModeData1024x768x32
    44, // ModeData1280x1024x16
    44, // ModeData1280x1024x16
    45, // ModeData1600x1200x8
    48, // ModeData640x480x8xOEM
    52, // ModeData800x600x4xOEM
    56, // ModeData800x600x8xOEM
    60, // ModeData1024x768x4xOEM
    64, // ModeData1024x768x8xOEM
    65, // ModeData1152x864x8xOEM
    69, // ModeData1280x1024x4xOEM
...
//     mov  bx, (VESAModeInfo ptr ds:[si]).BytesPerScanLine;bx = BytesPerScanLine
    r.h.bl = vesaModeInfo[0x01];
    r.h.bh = vesaModeInfo[0x02];
