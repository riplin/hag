...
Label0xeb:                              ;Offset 0xeb
    ...
    out       dx, ax
    mov       cx, 0078h
    call      PowerUpPLLsLUTSAndConfigure;Offset 0x7b21
    call      SetMemoryTimingsAndRefresh ;Offset 0x7a04
    push      bx
    mov       al, 40h                   ;Color
...
GetProtectedModeInterface:              ;Offset 0x5e73
    ...
    mov       ax, cs
    mov       es, ax
    mov       di, offset PINS           ;Offset 0x7d00
    xor       ax, ax
    mov       al, byte ptr es:[di + 02h]
    add       di, ax
...
Label0x5ed0:                            ;Offset 0x5ed0
    push      si
    mov       bx, ax
    add       si, offset PINS           ;Offset 0x7d00
...
ConfigureAndSelectPLLSetsAB PROC NEAR   ;Offset 0x6f83
    ...
    push   ebx
    push   ecx
    mov    cl, byte ptr cs:[PLLADefaultFreq];Offset 0x7d29
    cmp    cl, 0ffh
...
Label0x6fa7:                            ;Offset 0x6fa7
    ...
    call   ConfigurePixelClocks         ;Offset 0x6e51
    mov    cl, byte ptr cs:[PLLBDefaultFreq];Offset 0x7d2a
    cmp    cl, 0ffh
...
SetMemoryTimingsAndRefresh PROC NEAR    ;Offset 0x7a04
    push   ax
    push   bx
    push   ecx
    push   dx
...
PowerUpPLLsLUTSAndConfigure PROC NEAR   ;Offset 0x7b21
    push  ax
    push  bx
    push  ecx
    push  edx
...
;Offset 0x7d3a
Data0x7d3a              DB 000h         ;bit 1-0 = mbuftype in OPTION2
