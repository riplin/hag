...
PCI_DEVICE_MillenniumII                 EQU 051bh;0x051b
...
entry:                                  ;Offset 0x80
    call      Func0x5149                ;Offset 0x5149
    mov       bx, ax
    call      Func0x51e5                ;Offset 0x51e5
...
NextCharacter:                          ;Offset 0x3b2
    ...
    mov   ah, 0eh                       ;Offset 0x3be - Teletype Output
    int   10h
...
TextFunctions PROC NEAR                 ;Offset 0x200b
    lea       si, [Func0x2038]          ;Offset 0x2038
    cmp       al, 10h
    jb        Label0x2029               ;Offset 0x2029
    lea       si, [Func0x2059]          ;Offset 0x2059
    cmp       al, 20h
    jb        Label0x2029               ;Offset 0x2029
    lea       si, [Func0x2074]          ;Offset 0x2074
    cmp       al, 30h
    jb        Label0x2029               ;Offset 0x2029
    jne       Label0x2037               ;Offset 0x2037
    call      Func0x20d8                ;Offset 0x20d8
    ret
...
Func0x2038 PROC NEAR                    ;Offset 0x2038
    cmp       al, 03h
    je        Label0x2050               ;Offset 0x2050
    cmp       al, 04h
    ja        Label0x2058               ;Offset 0x2058
    and       bl, 7fh
    call      Func0x2717                ;Offset 0x2717
    call      Func0x2758                ;Offset 0x2758
    call      Func0x271d                ;Offset 0x271d
...
Func0x2059 PROC NEAR                    ;Offset 0x2059
    cmp       al, 03h
...
Func0x2074 PROC NEAR                    ;Offset 0x2074
    cmp       al, 04h
...
Func0x20d8 PROC NEAR                    ;Offset 0x20d8
    mov       cx, word ptr ds:[BDA_PointHeightOfCharacterMatrix];Offset 0x485
...
DisplayCombinationCodeFunctions PROC NEAR;Offset 0x2329
    ...
    xor       ah, ah
    dec       ax
    js        Label0x2338               ;Offset 0x2338
    jne       Label0x233d               ;Offset 0x233d
    call      SetDisplayCombinationCodeIndex;Offset 0x2b54
    jmp       Label0x233b               ;Offset 0x233b
Label0x2338:                            ;Offset 0x2338
    call      Func0x2b7b                ;Offset 0x2b7b
Label0x233b:                            ;Offset 0x233b
    mov       al, 1ah
Label0x233d:                            ;Offset 0x233d
    pop       es
    pop       dx
    pop       cx
    ret
...
Func0x2b7b PROC NEAR                    ;Offset 0x2b7b
    push  di
    push  es
    mov   bx, 0ffffh
    mov   al, BDA_VPCB_DisplayCombinationCodePtr;0x2
...
Func0x5149 PROC NEAR                    ;Offset 0x5149
    push ax
    push si
    push di
    xor  si, si
Label0x514e:                            ;Offset 0x514e
    ...
    mov  cx, MGA_MemAddr_PalletteRamWriteAddress;0x3c00
    int  1ah
...
Func0x51e5 PROC NEAR                    ;Offset 0x51e5
    push di
...
Func0x520b PROC NEAR                    ;Offset 0x520b
    push cx
    mov  cl, MGA_INDD_Reserved3f;03fh ???
    call ReadIndexedRegister  ;0x578f
    cmp  cl, 30h
    pop  cx
    ret
Func0x520b ENDP
...
Label0x54b8:                            ;Offset 0x54b8
    ...
    cmp   ax, PCI_DEVICE_MillenniumII   ;0x051b
...
Label0x563a:                            ;Offset 0x563a
    ...
    xchg  al, ah
    in    al, dx
    and   al, NOT MGA_CRTEXT0_StartAddress20_16;0xf0
    or    al, ah
    out   dx, al
    pop   dx
    ret
...
Func0x57a8 PROC NEAR                    ;Offset 0x57a8
    push cx
    push si
...
Label0x70b2:                            ;Offset 0x70b2
    ...
    push  ax
    mov   ax, 0bd60h                    ;I don't understand this value
    int   6dh                           ;It just seems to ultimately call back to the System handler...
    pop   ax
    push  ds
    push  si
...
GetSetDACPaletteControl:                ;Offset 0x72d7
    ...
    xor  ah, ah
    mov  dh, 06h
    and  cl, MGA_MISCCTRL_DAC_Bit_MASK  ;08h
...
Label0x72fb:                            ;Offset 0x72fb
    ...
    mov  dh, 08h
    or   cl, MGA_MISCCTRL_DAC_8Bit      ;08h
...
DB 086h, 0C4h                           ;    xchg al, ah
DB 0ECh                                 ;    in   al, dx
DB 024h, 0F0h                           ;    and  al, NOT MGA_CRTEXT0_StartAddress20_16;0xf0
