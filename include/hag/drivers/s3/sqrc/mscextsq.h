...
namespace MiscellaneousExtendedSequencer
{
    ...
    {
        VGA::SequencerIndex::Write(SequencerRegister::MiscellaneousExtendedSequencer);
        return MiscellaneousExtendedSequencer_t(VGA::SequencerData::Read());
    }
    
    inline void Write(MiscellaneousExtendedSequencer_t value)
    {
        VGA::SequencerData::Write(SequencerRegister::MiscellaneousExtendedSequencer, VGA::SequencerData_t(value));
    }
