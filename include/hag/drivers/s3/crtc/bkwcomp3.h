...
namespace BackwardCompatibility3
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, CRTControllerRegister::BackwardCompatibility3);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, CRTControllerRegister::BackwardCompatibility3, VGA::CRTControllerData_t(value));
    }
