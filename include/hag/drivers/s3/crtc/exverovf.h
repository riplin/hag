...
namespace ExtendedVerticalOverflow
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, CRTControllerRegister::ExtendedVerticalOverflow);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, CRTControllerRegister::ExtendedVerticalOverflow, VGA::CRTControllerData_t(value));
    }
