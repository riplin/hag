...
namespace BackwardCompatibility2
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, CRTControllerRegister::BackwardCompatibility2);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, CRTControllerRegister::BackwardCompatibility2, VGA::CRTControllerData_t(value));
    }
