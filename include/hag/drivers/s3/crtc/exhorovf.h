...
namespace ExtendedHorizontalOverflow
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, CRTControllerRegister::ExtendedHorizontalOverflow);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, CRTControllerRegister::ExtendedHorizontalOverflow, VGA::CRTControllerData_t(value));
    }
