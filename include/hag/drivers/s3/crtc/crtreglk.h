...
namespace CRTRegisterLock
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, CRTControllerRegister::CRTRegisterLock);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, CRTControllerRegister::CRTRegisterLock, VGA::CRTControllerData_t(value));
    }
