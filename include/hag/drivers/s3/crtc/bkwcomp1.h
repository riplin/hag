...
namespace BackwardCompatibility1
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, CRTControllerRegister::BackwardCompatibility1);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, CRTControllerRegister::BackwardCompatibility1, VGA::CRTControllerData_t(value));
    }
