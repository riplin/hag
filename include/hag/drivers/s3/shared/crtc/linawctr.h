...
namespace LinearAddressWindowControl
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, Register::LinearAddressWindowControl);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, Register::LinearAddressWindowControl, VGA::CRTControllerData_t(value));
    }
