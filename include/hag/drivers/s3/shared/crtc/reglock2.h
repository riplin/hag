...
namespace RegisterLock2
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, Register::RegisterLock2);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, Register::RegisterLock2, VGA::CRTControllerData_t(value));
    }
