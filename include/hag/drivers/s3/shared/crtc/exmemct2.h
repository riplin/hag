...
namespace ExtendedMemoryControl2
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, Register::ExtendedMemoryControl2);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, Register::ExtendedMemoryControl2, VGA::CRTControllerData_t(value));
    }
