...
namespace MemoryConfiguration
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, Register::MemoryConfiguration);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, Register::MemoryConfiguration, VGA::CRTControllerData_t(value));
    }
