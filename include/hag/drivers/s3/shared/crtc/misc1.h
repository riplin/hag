...
namespace Miscellaneous1
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, Register::Miscellaneous1);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, Register::Miscellaneous1, VGA::CRTControllerData_t(value));
    }
