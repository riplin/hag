...
namespace ExtendedSystemControl1
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, Register::ExtendedSystemControl1);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, Register::ExtendedSystemControl1, VGA::CRTControllerData_t(value));
    }
