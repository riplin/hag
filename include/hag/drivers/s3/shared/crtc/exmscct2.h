...
namespace ExtendedMiscellaneousControl2
{
    ...
    {
        VGA::CRTControllerIndex::Write(controllerIndexRegister, Register::ExtendedMiscellaneousControl2);
    ...
    {
        VGA::CRTControllerData::Write(controllerIndexRegister, Register::ExtendedMiscellaneousControl2, VGA::CRTControllerData_t(value));
    }
