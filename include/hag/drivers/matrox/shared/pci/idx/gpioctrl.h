...
{
    inline Shared::Indexed::GeneralPurposeIOControl_t Read(System::PCI::Device_t device)
    {
        return IndexedData::Read(device, Shared::Indexed::Register::GeneralPurposeIOControl);
    }
    inline void Write(System::PCI::Device_t device, Shared::Indexed::GeneralPurposeIOControl_t value)
    {
