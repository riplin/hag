...
{
    inline Shared::Indexed::CursorBaseAddressHigh_t Read(Has::System::PCI::Device_t device)
    {
        return IndexedData::Read(device, Shared::Indexed::Register::CursorBaseAddressHigh);
    }
    inline void Write(Has::System::PCI::Device_t device, Shared::Indexed::CursorBaseAddressHigh_t value)
    {
