...
{
    inline Shared::Indexed::ColorKeyMaskLow_t Read(System::PCI::Device_t device)
    {
        return IndexedData::Read(device, Shared::Indexed::Register::ColorKeyMaskLow);
    }
    inline void Write(System::PCI::Device_t device, Shared::Indexed::ColorKeyMaskLow_t value)
    {
