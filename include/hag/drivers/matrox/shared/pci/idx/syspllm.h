...
{
    inline Shared::Indexed::SystemPLLM_t Read(Has::System::PCI::Device_t device)
    {
        return IndexedData::Read(device, Shared::Indexed::Register::SystemPLLM);
    }
    inline void Write(Has::System::PCI::Device_t device, Shared::Indexed::SystemPLLM_t value)
    {
