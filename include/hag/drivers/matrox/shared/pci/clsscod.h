...
typedef Has::System::PCI::Register_t ClassCode_t;
...
namespace ClassCode
{
    ...
    inline ClassCode_t Read(Has::System::PCI::Device_t device) { return Has::System::PCI::Read32(device, Register::ClassCode); }
}
